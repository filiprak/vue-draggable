(function () {
    ...
    const EVT_DRAG_START = 'v-draggable.drag-start';
    const EVT_DRAG_END = 'v-draggable.drag-end';

    const DATA_KEY = 'v-draggable';
    const DATA_DROP_TARGET_KEY = 'v-drop-target';
    ...
    const config = {
        ...
        update: function (el, binding, vnode) {
                ...
                if (mouse_el) {
                    ...
                    if (data.target_el) {
                        ...
                        if (target_data.snap_interval) {
                            ...
                            data.ghost_el.style.top = pixels(target_top - target_top % target_data.snap_interval);
                        }
                    }
            ...
            function createDraggedElement() {
                ...
                dragged.style.top = pixels(rect.top);
                dragged.style.left = pixels(rect.left);
                dragged.style.width = pixels(rect.width);
                dragged.style.height = pixels(rect.height);
            ...
            function createGhostElement() {
                ...
                ghost.style.height = pixels(rect.height);
